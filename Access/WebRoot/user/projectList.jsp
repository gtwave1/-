                ...
                <ul class="nav">
                    <li>
                        ...
                        <ul class="menu-collapse collapse in" id="ui_menu_me">
                            <li>
                                <a href="<c:url value='/user/zeroPoint.jsp'/>">
                        ...
                        <ul class="menu-collapse collapse in" id="ui_menu_use">
                            ...
                            <li>
                                <a href="/zzz/pai.jsp">
                  					<i class="icon icon-lg">vertical_align_top</i>&nbsp;项目排行
                				</a>
                            </li>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table">
                                                    ...
                                                    <c:forEach items="${pb.beanList}" var="cstm">
														<tr>
															<td>${cstm.projectName}</td>
															<td>${cstm.principal }</td>
															<td>${cstm.phone }</td>
															<td>${cstm.category }</td>
															<td>${cstm.kind }</td>
															<c:choose>
																<c:when test="${cstm.statu == 2}">
																	<td>待评分</td>
																	<td></td>
																	<td>
																		<a href="<c:url value='/ProjectServlet?method=find&tid=${cstm.tid}'/>">查看详情</a>&nbsp;
																		<a href="<c:url value='/user/access.jsp?id=${cstm.id }'/>">进行评分</a>
																	</td>
																</c:when>
																<c:otherwise>
																	<td>已评分</td>
																	...
																	<td>
																		<a href="<c:url value='/ProjectServlet?method=find&tid=${cstm.tid}'/>">查看详情</a>&nbsp;
																		<a href="#" onclick="javascript:alert('请勿重复评分！'); return false;" >进行评分</a>
																	</td>
																</c:otherwise>
															</c:choose>
															<td>
