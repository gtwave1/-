...
<body class="page-orange">
    ...
    <main class="content">
        <div class="content-header ui-content-header">
            <div class="container">
                <h1 class="content-heading">比赛信息</h1>
            </div>
        </div>
        <div class="container">
                                        ...
                                        <c:choose>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table">
                                                    ...
                                                    <tr>
                                                        <th>大赛详情</th>
                                                        <td>${gameInfo.detail }</td>
                                                    </tr>
                                                    <tr>
                                                        <th>大赛分组</th>
                                                        <td>
                                                        	<c:choose>
                                                        		<c:when test="${gameInfo.kind == 0 }">不分组</c:when>
                                                        		<c:otherwise>大一组、大二/大三组</c:otherwise>
                                                        	</c:choose>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <th>大赛文件</th>
                                                        <td><a href="<c:url value="/GameServlet?method=download&id=${gameInfo.id }" />" style="cursor:pointer">点此下载</a></td>
                                                    </tr>
                                                </table>
                                            </div>
                                        </div>
