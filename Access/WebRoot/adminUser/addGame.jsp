...
<body class="page-orange">
    ...
    <main class="content">
        <div class="content-header ui-content-header">
            <div class="container">
                <h1 class="content-heading">发起比赛</h1>
            </div>
        </div>
        <div class="container">
                        ...
                        <div class="card margin-bottom-no">
                            <div class="card-main">
                                <div class="card-inner">
                                    <div class="card-inner">
                                        <p class="card-heading">注册比赛</p>
                                        <form method="post" action="<c:url value='/GameServlet?method=add'/>" enctype="multipart/form-data">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table">
                                                    ...
                                                    <tr>
                                                    	<th style="text-align: right;">比赛简介</th>
                                                    	<td><textarea name="detail" rows="10" cols="50"  style="resize:none" ></textarea></td>
                                                    	<td></td>
                                                    </tr>
                                                    <tr>
                                                    	<th style="text-align: right;">比赛分组设置</th>
                                                    	<td>
                                                    		<input type="radio" name="kind" value="0" checked/>
                                                    		<span>不分组</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                    		<input type="radio" name="kind" value="1" />
                                                    		<span>大一/大二、大三组别</span>
                                                    	</td>
                                                    	<td style="color: red; text-align: left;"></td>
                                                    </tr>
                                                    <tr>
                                                    	<th style="text-align: right;">报名开始时间</th>
                                                    	<td><input type="date" name="start" style="width: 380px;"/></td>
                                                    	<td></td>
                                                    </tr>
                                                    <tr>
                                                    	<th style="text-align: right;">比赛相关文件</th>
                                                    	<td><input type="file" accept="application/zip, application/msword, application/pdf, application/vnd.openxmlformats-officedocument.wordprocessingml.document" name="word" style="width: 380px;"/></td>
                                                    	<td style="color: red; text-align: left;">仅接受 *.docx、*.doc、*.pdf、*.zip文件的上传</td>
                                                    </tr>
                                                    <tr>
                                                    	<td></td>
